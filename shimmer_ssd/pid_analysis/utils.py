...
def find_optimal_lr(model, train_ds, batch_size: int = 256, start_lr: float = 1e-9, end_lr: float = 1e5, num_iter: int = 500, skip_start: int = 10, skip_end: int = 5, factor: float = 10.0, log_to_wandb: bool = False, seed: int = 42, return_finder: bool = False) -> Union[float, Tuple[float, LRFinder]]:
